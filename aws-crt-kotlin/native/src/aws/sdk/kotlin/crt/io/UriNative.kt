...
internal actual fun parseUri(uri: String): Uri {
    return memScoped {
        uri.encodeToByteArray().usePinned { pinned ->
            ...
            println("awsUri: $awsUri")
            println("awsUri.scheme: ${awsUri.scheme.toKString()}")
            println("awsUri.host: ${awsUri.host_name.toKString()}")
            println("awsUri.port: ${awsUri.port.toInt()}")
            println("awsUri.path: ${awsUri.path.toKString()}")
            println("awsUri.parameters: ${awsUri.query_string.toKString()}")
//            println("awsUri.fragment: ${awsUri.fragment}")
            println("awsUri.userinfo: ${awsUri.userinfo.toKString()}")
//            println("awsUri.forceQuery: ${awsUri.forceQuery}")
