...
import aws.sdk.kotlin.runtime.crt.auth.credentials.Credentials
import aws.sdk.kotlin.runtime.crt.auth.credentials.CredentialsProvider
...
public class AwsSigningConfig(builder: Builder) {
     ...
     */
    public val date: Long = builder.date ?: aws.sdk.kotlin.runtime.crt.Platform.epochMilliNow()
